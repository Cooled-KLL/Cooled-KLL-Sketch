...
// #include "LightPartMultiInsert_lazy.h"
...
public:
	...
	int get_max_array_length_total(){
		return light_part->get_max_array_length_total();
	}
	int get_max_possible_level(){
		return light_part->get_max_possible_level();
	}
    int get_bucket_number(){
        return heavy_part->bucket_num;
    }
};
