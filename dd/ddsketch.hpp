...
namespace sketch {
    ...
    #ifdef DICT_COLLAPSE
        DDSketch(u32 cap_, f64 alpha_, elem_t range, u32 counter_number);
    #else
        DDSketch(u32 cap_, f64 alpha_, elem_t range);
    #endif
    ...
    // private:
        ...
        virtual void append(elem_t item, u32 pos);
    };
    
    class UDDSketch : public DDSketch{
    public:
        UDDSketch(u32 cap_, f64 alpha_, elem_t range, u32 counter_number);
        void append(elem_t item, u32 pos) override;
    };
}   // namespace sketch
