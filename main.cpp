...
// #define BUCKET_SIZE_EXPERIMENT_RANGE_L 2
...
public:
    ...
    void Run(uint32_t sketch_memory = 256 * 1024, bool print_first_line_flag = true){
        ...
        // for (double lambda = 0.3; lambda < 1; lambda+= 0.3){
        //     sketch_list.push_back(new ElasticKLL(sketch_memory, 0.05, lambda));
        //     sketch_name_list.push_back(doubleToString(lambda));
        // }
        // for (int lambda = 2; lambda <= 5; lambda++){
        //     sketch_list.push_back(new ElasticKLL(sketch_memory, 0.05, lambda));
        ...
        // for (double a = 1e-3; a <= 1e-2; a += 1e-3){
        //     sketch_list.push_back(new DD(sketch_memory, min_e, max_e, a));
        //     sketch_name_list.push_back("DD" + doubleToString(a));
        // }
        // for (double a = 1e-3; a <= 1e-2; a += 1e-3){
        //     sketch_list.push_back(new UDD(sketch_memory, min_e, max_e, a));
        //     sketch_name_list.push_back("UDD" + doubleToString(a));
        // }
        // sketch_list.push_back(new DD(sketch_memory, min_e, max_e, 1e-3));
        // sketch_name_list.push_back("DD");
        // sketch_list.push_back(new UDD(sketch_memory, min_e, max_e, 1e-3));
        // sketch_name_list.push_back("UDD");

        
        // sketch_list.push_back(new ElasticKLL(32 * 1024));
        // sketch_name_list.push_back("Cooled-KLL-32KB");
        // sketch_list.push_back(new ElasticKLL(64 * 1024));
        // sketch_name_list.push_back("Cooled-KLL-64KB");
        // sketch_list.push_back(new ElasticKLL(128 * 1024));
        // sketch_name_list.push_back("Cooled-KLL-128KB");
        // sketch_list.push_back(new ElasticKLL(256 * 1024));
        // sketch_name_list.push_back("Cooled-KLL-256KB");
    ...
    #ifdef BUCKET_SIZE_EXPERIMENT
    #if COUNTER_PER_BUCKET != BUCKET_SIZE_EXPERIMENT_RANGE_L
        print_first_line_flag = false;
    #endif
    #endif
    ...
    #ifdef BUCKET_SIZE_EXPERIMENT
        fprintf(fp1_aqe, "%d,", COUNTER_PER_BUCKET);
        fprintf(fp2_are, "%d,", COUNTER_PER_BUCKET);
        fprintf(fp3_throughput, "%d,", COUNTER_PER_BUCKET);
        fprintf(fp4_aqe_time, "%d,", COUNTER_PER_BUCKET);
        fprintf(fp5_are_time, "%d,", COUNTER_PER_BUCKET);
        fprintf(fp6_aqe_distribution, "(%d)", COUNTER_PER_BUCKET);
        fprintf(fp7_are_distribution, "(%d)", COUNTER_PER_BUCKET);
    #else
...
{    
    ...
    // benchmark.Run();
#endif
    uint32_t start_mem = 32 * 1024;
    uint32_t end_mem = 256 * 1024;
